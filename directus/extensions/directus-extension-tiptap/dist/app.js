import { defineComponent, ref, onMounted, onBeforeUnmount, h, getCurrentInstance, watchEffect, nextTick, unref, Teleport, shallowRef, reactive, markRaw, customRef, openBlock, createElementBlock, renderSlot, watch, resolveComponent, Fragment as Fragment$1, createVNode, createElementVNode } from 'vue';
...
const _hoisted_1$1 = { class: "my-1.5 inline-flex flex-row flex-wrap items-center space-x-1 px-2" };
...
script$1.__file = "src/editor/components/ToolbarGroup.vue";

var script = {
  components: {
    EditorContent,
    ToolbarGroup: script$1,
  },
...
const _hoisted_1 = /*#__PURE__*/createElementVNode("span", null, "titu", -1 /* HOISTED */);
