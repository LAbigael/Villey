import { defineComponent, ref, onMounted, onBeforeUnmount, h, getCurrentInstance, watchEffect, nextTick, unref, Teleport, shallowRef, reactive, markRaw, customRef, watch, resolveComponent, openBlock, createElementBlock, Fragment as Fragment$1, createElementVNode, createVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment$1, null, [
    createElementVNode("button", {
      onClick: _cache[0] || (_cache[0] = $event => ($setup.editor.chain().focus().insertContent({ type: 'footnote' }).run()))
    }, " insert footnote "),
