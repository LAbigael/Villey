import { defineComponent, ref, onMounted, onBeforeUnmount, h, getCurrentInstance, watchEffect, nextTick, unref, Teleport, shallowRef, reactive, markRaw, customRef, openBlock, createElementBlock, createElementVNode, watch, resolveComponent, Fragment as Fragment$1, normalizeClass, createVNode } from 'vue';
...
const _hoisted_2 = /*#__PURE__*/createElementVNode("path", { d: "M8 11h4.5a2.5 2.5 0 1 0 0-5H8v5zm10 4.5a4.5 4.5 0 0 1-4.5 4.5H6V4h6.5a4.5 4.5 0 0 1 3.256 7.606A4.498 4.498 0 0 1 18 15.5zM8 13v5h5.5a2.5 2.5 0 1 0 0-5H8z" }, null, -1 /* HOISTED */);
const _hoisted_3 = [
  _hoisted_2
];
...
script$1.__file = "src/icons/bold.vue";
...
var script = {
  ...
  setup(props, { emit }) {
    const editor = useEditor({
      extensions: [StarterKit, footnoteNode],
      onUpdate: ({ editor }) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment$1, null, [
    createElementVNode("button", {
      ...
      active: $setup.editor?.isActive('bold'),
      class: normalizeClass(["button active", { active: $setup.editor?.isActive('bold') }])
    }, [
      createVNode(_component_Bold)
